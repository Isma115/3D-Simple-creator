...
- Mantener el toast temporal de `Meta + rueda` para recorrer modos de control.
- Mantener un panel de ayuda visual más compacto, generado por modo con tarjetas pequeñas y etiquetas breves como `LMB`, `RMB`, `WASD` o `CTRL`.
